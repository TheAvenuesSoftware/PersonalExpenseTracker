...
async function login_step3(userEmailAddress,createNewAccount){
    // const overlay = document.getElementById("busy-animation");
...
function login_step1(emailAddress="",createNewAccount){ // get UserEmailAddress; validate userEmailAddress
    ...
    // 
        overlay.id = "transient-message-overlay";
    ...
    // 
        p1.textContent = "Please enter your login email address.";
