...
robocopy C:\__TheAvenuesSoftware\__Global\config .\config globalClientConfig.js
robocopy C:\__TheAvenuesSoftware\__Global\config .\config globalNode.env
robocopy C:\__TheAvenuesSoftware\__Global\config .\config globalNodeConfig.js
robocopy C:\__TheAvenuesSoftware\__Global\styles .\styles global.css
pause